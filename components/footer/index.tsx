        ...
        <footer>
            <div className="footer p-10 bg-base-200 text-base-content">
                <div>
                    ...
                    <p>Ar Rimal, Riyadh Saudi Arabia</p>
                    <Link href={'https://www.google.com/maps?q=24.904484,46.804367'}><p className="link link-hover">Google Map</p></Link>
                </div>
                <div>
                ...
                <div>
                    ...
                    <Link href={'https://medhalriding.com/terms-and-conditions.html'} className="link link-hover">Terms and Conditions</Link>
                </div>
                <div>
                    <span className="footer-title">Worktime</span>
                    <p>Monday - Saturday</p>
                    <p>8pm - 2am</p>
                </div>
            </div>
            ...
            <div className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                ...
                <div className="md:place-self-center md:justify-self-end">
                    <div className="grid grid-flow-col gap-4">
                        ...
                        <Link href={''}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" /></svg></Link>
                    </div>
                </div>
            </div>
        </footer>
